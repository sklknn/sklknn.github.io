...
А, ну еще можно поднять сервер по любой компьютерной игре для друзей, личто я поднимал minecraft, ark и space station 14. Как по мне - Debian > Ubuntu server, хотя для личного пользования я всё-равно выбираю Arch, об этом ниже.
:::
...
![img](./assets/scr3.png)
![img](./assets/scr4.png)
Ну и естественно,все это соправажденно скриптом для автоматического развертывания всего этого великолепия на голой системе без всего.
:::